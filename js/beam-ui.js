  ...
  function renderProjectPage(state) {
    return `
      <div class="page-card compact-page">
        ...
        <div class="muted" style="margin-top: 12px;">New files start empty. Add levels from the Gravity section in the table of contents.</div>
      </div>
    `;
  }
            ...
            <div class="box wood-entry-box">
              ...
              <div class="box-body">
                <table class="summary-table compact-summary-table design-entry-table"><tbody>
                  <tr><th>Species</th><td colspan="2"><select class="select yellow-input" data-design-field="materialId">${materials.map((item) => `<option value="${item.id}" ${design.materialId === item.id ? 'selected' : ''}>${escapeHtml(item.name)}</option>`).join('')}</select></td></tr>
            ...
            <div class="box wood-factors-box">
              ...
              <div class="box-body">
                <table class="summary-table compact-summary-table"><tbody>
                  ...
                  <tr>
                    <th>CF</th><td><input class="input yellow-input" data-design-field="cf" value="${formatInput(calc.cf)}" /></td>
                  </tr>
                  <tr>
